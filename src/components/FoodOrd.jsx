...
const FoodOrd = () => {
  ...
  return (
    <div className={blur ? "blur-background" : "topN"}>
      ...
      <main id="main">
        <section>
          <div style={{marginTop:"8pc"}} className="container">
            <div className="d-md-flex  getMarginTop  justify-content-between gap-md-3">
              ...
              <li style={{ listStyle: "none" }} className="nav-item py-1 d-flex gap-3">
            ...
            <h5 className="py-3">Popular filters</h5>
              ...
              <div className="scroll-div">
                ...
                <h3>
                  <i className="fs-3 fa-brands fa-accessible-icon"></i> Promotions
                </h3>
                  ...
                  <div className="col-md-4 col-12 px-md-3 px-4 shadow rounded">
                        ...
                        <div>
                          ...
                          <h5 style={{ color: " #AE8625" }}>
                            <i className="fa-solid fs-3 fa-person-running"></i>FREE
                          </h5>
                        </div>
                  </div>
                      </>
