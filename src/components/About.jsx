      ...
      {isloading ? (
        ...
        <>
            ...
            <div className="container-fluid">
              <div className="row mt-md-5 px-md-5 ">
                ...
                <div className="col-md-6 mt-md-0  mt-5 col-12">
                  ...
                  <p>
                    Welcome to Our Hotel, Experience a world of comfort and
                    luxury at our elegant hotel. With stunning views,
                    exceptional service, and top-notch amenities, your stay with
                    us will be truly unforgettable.
                  </p>
                  <p>
                    Fine Dining Experience, Indulge your senses in a culinary
                    journey like no other. Our talented chefs craft exquisite
                    dishes that blend local flavors with international cuisine,
                  ...
                  <button className="btn py-3 px-4 fw-bold">
                    Discover More
                  </button>
                </div>
              </div>
            ...
            <div className="container-fluid">
              <div className="row mt-md-5 py-5 mt-5 px-md-5 py-md-5 ">
                ...
                <div className="col-md-6 mt-5 col-12">
                  <h5 className="about_h5 mt-md-0 mt-4">
                    Luxury Hotel & Resort
                  </h5>
          ...
          <section className="blog">
            <div
              style={{ backgroundColor: "#c1bebe61" }}
              className="text-center container-fluid py-5 "
            >
              ...
              <div className="d-md-flex col-12 justify-content-center pb-5 text-center">
                <input
                  type="text"
                  className="py-3 col-md-4 col-8 rounded bg-light shadow border border-none"
                  placeholder="Your Email Address"
                />
                <button className="btn py-md-3 py-3 px-1 px-md-4">
                  SUBSCRIBE NOW
                </button>
              </div>
            </div>
